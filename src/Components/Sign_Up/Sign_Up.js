    ...
    <div className="signup-form">
      <form method="POST" onSubmit={register}>
        <div className="form-group">
          ...
          <input value={role} type="text" onChange={(e) => setRole(e.target.value)} name="role" id="role" className="form-control" placeholder="Enter your role" aria-describedby="helpId" />
        </div>
        <div className="form-group">
